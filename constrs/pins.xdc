...
set_property PACKAGE_PIN K16 [get_ports {LED[3]}]
set_property PACKAGE_PIN M16 [get_ports {LED[4]}]
set_property PACKAGE_PIN M13 [get_ports {DIP[1]}]
set_property PACKAGE_PIN L13 [get_ports {DIP[2]}]
set_property PACKAGE_PIN J17 [get_ports {DIP[3]}]
set_property PACKAGE_PIN K17 [get_ports {DIP[4]}]
...
# SFP port to AMANEQ ---------------------------------------------------
set_property PACKAGE_PIN C18 [get_ports MIKUMARI_RXP]
set_property PACKAGE_PIN C19 [get_ports MIKUMARI_RXN]
set_property PACKAGE_PIN B21 [get_ports MIKUMARI_TXP]
set_property PACKAGE_PIN A21 [get_ports MIKUMARI_TXN]
