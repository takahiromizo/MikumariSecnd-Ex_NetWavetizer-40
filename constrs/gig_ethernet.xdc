...
set_property PACKAGE_PIN A8 [get_ports GTP_RX_N]
set_property PACKAGE_PIN B8 [get_ports GTP_RX_P]
set_property PACKAGE_PIN A4 [get_ports GTP_TX_N]
set_property PACKAGE_PIN B4 [get_ports GTP_TX_P]
...
create_clock -period 8.000 -name gtrefclk -add [get_ports GTP_REFCLK_P]
